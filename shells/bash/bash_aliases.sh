...
latexdiff --flatten -t TRADITIONAL  --append-textcmd="abstract" $1 $2 > ${2%\.tex}-diff.tex
# -t TRADITIONAL CFONT FONTSTRIKE INVISIBLE
# --showall --math-markup=1 --driver=pdftex --type=CFONT -t UNDERLINE
