...
function uStart(){
    apps="ubuntu-restricted-extras flashplugin-installer  openjdk-7-jre
          ...
          texlive-fonts-recommended latexmk biblatex biber
...
function texLink(){
    unalias ln
linkfrom=~/SparkleShare/phdtex/thesis/
linkto=$1
...
tClearup(){
    ...
    dir=" 00data  01tex 02code 03pdf 04doc 05pic 06audio 05video 09exe 08back "
