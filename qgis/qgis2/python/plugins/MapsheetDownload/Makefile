...
# translation
SOURCES = mapsheetdownload.py ui_mapsheetdownload.py __init__.py mapsheetdownloaddialog.py
#TRANSLATIONS = i18n/mapsheetdownload_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = mapsheetdownload

PY_FILES = mapsheetdownload.py mapsheetdownloaddialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_mapsheetdownload.py
